...
$pageTitle = 'Login Admin - Sistem Peminjaman Barang';
...
<div class="min-h-screen bg-gray-900 flex items-center justify-center px-4">
    <div class="bg-gray-800 rounded-2xl shadow-2xl w-full max-w-md p-8">
        <h2 class="text-2xl underline font-extrabold tracking-tighter text-white mb-6 text-center">Login Admin / Petugas</h2>
